...
public class Ser4 {
	...
	public Ser4(int port) { //待ち受けポートを引数とする
...
public static Group chat(String name) { //グループのチャット情報取得
...
public static void main(String[] args) { //main
		...
		Ser4 server = new Ser4(10084); //待ち受けポート10000番でサーバオブジェクトを準備
